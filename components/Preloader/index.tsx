...
const words: string[] = [ "नमस्ते", "Hello", "Bonjour", "Ciao", "Olà", "やあ", "Hallå", "Guten tag", "Hallo"]
...
export default function Index(): JSX.Element {
    ...
    return (
        <motion.div variants={slideUp} initial="initial" exit="exit" className="h-screen w-screen flex items-center justify-center fixed z-[999] bg-[#141516] ">
            {dimension.width > 0 && 
            <>
                <motion.p variants={opacity} initial="initial" animate="enter" className="flex text-[white] text-[42px] items-center absolute z-[1]"><span className="block w-2.5 h-2.5 bg-[white] mr-2.5 rounded-[50%]"></span>{words[index]}</motion.p>
